...
const schema = yup.object().shape({
  ...
  email: yup.string(),
  amount: yup.string().required("Address is a required field!"),
});
...
const Courier = () => {
  ...
  const AddCourierFunc = async (values) => {
    ...
    await axios({
      method: "POST",
      url: `${process.env.REACT_APP_BASE_URL}/settings_api/courier/`,
      data: formfield,
    })
      .then((response) => {
        setMessage(response.success, "Courier is successfuly created...");
        navigate("/courier");
  ...
  const UpdateCourierFunc = async (values) => {
    ...
    await axios({
      method: "PUT",
      url: `${process.env.REACT_APP_BASE_URL}/settings_api/courier/${item.id}/`,
      data: formfield,
    })
      .then((response) => {
        setMessage(response.success, "Courier is successfully updated...");
        window.location.reload(false);
      })
      .catch((error) => {
        setMessage(error.message, "Error");

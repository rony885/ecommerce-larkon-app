...
const Unit = () => {
  ...
  const AddUnitFunc = async (values) => {
    ...
    await axios({
      method: "POST",
      url: `${process.env.REACT_APP_BASE_URL}/product_api/unit/`,
      data: formfield,
    })
      .then((response) => {
  ...
  const UpdateBrandFunc = async (values) => {
    ...
    await axios({
      method: "PUT",
      url: `${process.env.REACT_APP_BASE_URL}/product_api/unit/${item.id}/`,
      data: formfield,
    })
      .then((response) => {
                          ...
                          {({
                            ...
                            >
                              ...
                              <div className="modal-footer">
                                ...
                                >
                                  {isSubmitting ? "Submitting..." : "Unit Add"}
                                </button>
                                <button
                                  type="button"
